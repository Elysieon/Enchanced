...
public class KineticWeaponComponentMixin {
    ...
    private void impaling$usageTick(ItemStack itemStack, int remainingUseTicks, LivingEntity user, EquipmentSlot slot, Operation<Void> original) {
        if (!EnchantUtils.hasEnchantment(user, itemStack, EnchancedEnchantments.IMPALING)) {
